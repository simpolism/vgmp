...
- Offline album art from track images and conventional folder/ZIP cover files
...
- Configurable embedded-loop repeats for formats that provide loop metadata
...
- Sega Saturn: `.ssf`, `.minissf`
- Sega Dreamcast: `.dsf`, `.minidsf`
